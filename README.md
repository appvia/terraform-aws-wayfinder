...
| <a name="input_enable_cloud_resource_provisioning"></a> [enable\_cloud\_resource\_provisioning](#input\_enable\_cloud\_resource\_provisioning) | Whether to enable cloud resource provisioning for Wayfinder. | `bool` | `false` | no |
...
| <a name="input_enable_peering_acceptor"></a> [enable\_peering\_acceptor](#input\_enable\_peering\_acceptor) | Whether to enable the peering acceptor for Wayfinder. | `bool` | `false` | no |
